...
class Interval(pythagoras.Interval):
    def basic_part(self):
        octaves = (self.interval_class - 1)//9
        basic_class = self.interval_class - octaves*9
...
EXTRA_CHORDS = {
    ...
    "sp7": ("P1", "P3", "m5", "m7"),
    "sp9": ("P1", "P3", "m5", "m7", "m9"),
    "sp11": ("P1", "P3", "m5", "m7", "m9", "m11"),
    "sp13": ("P1", "P3", "m5", "m7", "m9", "m11", "m13"),
    "sp15": ("P1", "P3", "m5", "m7", "m9", "m11", "m13", "m15"),
    "sp17": ("P1", "P3", "m5", "m7", "m9", "m11", "m13", "m15", "d17"),
    "sp19": ("P1", "P3", "m5", "m7", "m9", "m11", "m13", "m15", "d17", "d19"),
}


if __name__ == '__main__':
    from numpy import *
    target = log(7/4)/log(2)*1200
    by_error = []
    by_cents = []
