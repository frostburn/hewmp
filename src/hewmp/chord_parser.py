...
FLAVOR_CHORDS = {
    ...
    "11": (("P1", 0), ("M3", 1), ("P5", 0), ("m7", -1), ("M9", 0), ("P11", -1)),

    "#11": (("P1", 0), ("M3", 1), ("P5", 0), ("m7", -1), ("M9", 0), ("a11", 1)),

    "13": (("P1", 0), ("M3", 1), ("P5", 0), ("m7", -1), ("M9", 0), ("P11", -1), ("M13", 0)),
...
BASIC_CHORDS = {
    ...
    "m#13": (("P1", "m3", "P5", "m7", "M9", "P11", "M13"), (1, 3, 5)),
    "dom13": (("P1", "M3-", "P5", "m7", "M9", "M13"), (1,)),

    "M13#11": (("P1", "M3", "P5", "M7", "M9", "a11", "M13"), (1, 3, 5)),

    "M#15": (("P1", "M3", "P5", "M7", "M9", "M13", "a15"), (1, 3, 5, 6)),

    "M#15#11": (("P1", "M3", "P5", "M7", "M9", "a11", "M13", "a15"), (1, 3, 5, 7)),
    "m15#13": (("P1", "m3", "P5", "m7", "M9", "P11", "M13", "P15"), (1, 3, 5, 7)),
}
